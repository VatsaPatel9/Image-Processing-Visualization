/**
 * Color utility functions for color space conversions
 */
...
/**
 * Convert RGB to grayscale using specified method
 * @param {number} r - Red (0-255)
 * @param {number} g - Green (0-255)
 * @param {number} b - Blue (0-255)
 * @param {string} method - 'luminosity', 'average', or 'lightness'
 * @returns {number} Grayscale value (0-255)
 */
export function rgbToGrayscale(r, g, b, method = 'luminosity') {
  switch (method) {
    case 'luminosity':
